...
export_clang_coverage_vars() {
    ...
    export LLVM_PROFILE_FILE="$coverage_dir/cov_%p_%m.profraw"
    echo "Переменные окружения для фаззинга установлены:"
    echo "CC=$CC"
    echo "CXX=$CXX"
    echo "LLVM_PROFILE_FILE=$LLVM_PROFILE_FILE"
}

export_gcc_coverage_vars() {
    export CC="gcc"
    export CXX="g++"
    #export LDFLAGS="-fprofile-arcs -lgcov"
    #export CFLAGS="-fprofile-arcs -ftest-coverage -lgcov"
